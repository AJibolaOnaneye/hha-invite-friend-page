...
export default App;
  ...
  //         <p className='text-[32px] md:text-[40px] w-full max-w-[744px]'>Hi there, <span className='text-[#2AB34B]'>{userFirstName}.{userLastName?.slice(0,1)}</span>  wants you to join the HouseHelpApp family today. </p>
